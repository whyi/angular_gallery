...
(function() {
  describe("MenuController", function() {
    var HTTP_OK, MENU_JSON_API_PATH, SAMPLE_MENU_JSON, givenAjaxCallReturns, http, httpBackend, menuController, scope, thenAjaxCallIsMadeTo, thenLoadMenuJsonIsCalled, thenMenuJsonInScopeIs, whenInitialize, whenLoadMenuJson;
    ...
    givenAjaxCallReturns = function(json) {
      return httpBackend.when("GET", MENU_JSON_API_PATH).respond(HTTP_OK, json);
    };
